...
// Módulo principal de recopilación de datos de fuentes
...
export default async function collect_font_data(args) {
  ...
  for (let { source_path, source_bin } of args.font) {
    ...
    try {
      ...
      // Procesar diferentes tipos de datos de entrada
      ...
      // Usar los datos procesados para crear una instancia de fuente FreeType
